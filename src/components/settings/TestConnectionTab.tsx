...
export default function TestConnectionTab() {
    ...
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
        <div>
          ...
          <p className="text-sm md:text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-2xl leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative z-10">
        ...
        {/* คอลัมน์ซ้าย: Status & Graph */}
        <div className="lg:col-span-7 space-y-6">
          
          {/* Connection Status Card */}
          <div className="glass-card rounded-2xl p-5 md:p-6 border border-slate-200 dark:border-slate-900/60 relative overflow-hidden shadow-xl bg-white dark:bg-slate-900">
            ...
            {loading ? (
              ...
              <div className="space-y-6">
                ...
                <div className={`p-4 md:p-3.5 rounded-2xl flex items-start gap-3 border transition-all ${
                  result.success 
                    ? "bg-teal-500/5 border-teal-500/20 text-teal-600 dark:text-teal-300" 
                    : "bg-red-500/5 border-red-500/20 text-red-600 dark:text-red-300"
                }`}>
                  {result.success ? (
                    <CheckCircle2 className="w-5.5 h-5.5 md:w-5 md:h-5 text-teal-500 dark:text-teal-400 shrink-0 mt-0.5" />
                  ) : (
                    <XCircle className="w-5.5 h-5.5 md:w-5 md:h-5 text-red-500 dark:text-red-400 shrink-0 mt-0.5" />
                  )}
                  <div>
                    <h3 className="font-extrabold text-base md:text-sm flex items-center gap-1.5">
                      ...
                      {result.success && <span className="text-xs md:text-[10px] bg-teal-500/10 px-2 py-0.5 md:py-0.2 rounded-full text-teal-500 dark:text-teal-400 font-bold border border-teal-500/10">Active</span>}
                    </h3>
                    <p className="text-sm md:text-[11px] text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                      {result.message}
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <button 
                        ...
                        className="text-sm md:text-[10px] py-2 md:py-0 px-1 md:px-0 text-blue-500 hover:text-blue-400 font-bold flex items-center gap-1.5"
                      >
                        {showKeys ? (
                          <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-3 text-sm md:text-xs">
                      ...
                      {/* ENV Item 1 */}
                      <div className="p-4 md:p-3.5 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-850 flex flex-col justify-between gap-2">
                        <div>
              ...
              <div className="py-12 text-center text-slate-500 text-sm md:text-xs">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="glass-card rounded-2xl p-6 border border-slate-200 dark:border-slate-900/60 space-y-6 shadow-xl relative overflow-hidden bg-white dark:bg-slate-900">
            
            <div className="absolute top-[-30px] right-[-30px] w-24 h-24 bg-indigo-500/5 rounded-full blur-xl pointer-events-none" />
            
            <h3 className="text-xs font-extrabold text-slate-400 uppercase tracking-wider flex items-center gap-2 border-b border-slate-100 dark:border-slate-900 pb-3.5">
              <Key className="w-4 h-4 text-indigo-500" /> {t("test_connection.guide_title")}
            </h3>

            {/* แถบเลือกสเต็ปแบบแท็บ */}
            ...
            <div className="space-y-6 text-sm md:text-xs text-slate-650 dark:text-slate-300 font-bold">
              
              {/* Step 1: Create Supabase Project */}
              {activeStep === 1 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 md:w-8 md:h-8 bg-blue-500/10 border border-blue-500/20 text-blue-500 dark:text-blue-400 rounded-xl flex items-center justify-center font-bold text-sm md:text-xs shrink-0">
                      1
                    </div>
                    <h4 className="font-extrabold text-base md:text-sm text-slate-800 dark:text-slate-200">{t("test_connection.step1_title")}</h4>
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm md:text-xs leading-relaxed pl-1 font-medium">
              ...
              {activeStep === 2 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-800 dark:text-slate-200">{t("test_connection.step2_title")}</h4>
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm md:text-xs leading-relaxed pl-1 font-medium">
              ...
              {activeStep === 3 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-800 dark:text-slate-200">{t("test_connection.step3_title")}</h4>
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm md:text-xs leading-relaxed pl-1 font-medium">
              ...
              {activeStep === 4 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-800 dark:text-slate-200">{t("test_connection.step4_title")}</h4>
                  </div>
                  <p className="text-slate-500 dark:text-slate-400 text-sm md:text-xs leading-relaxed pl-1 font-medium">
            ...
            <div className="flex justify-between items-center border-t border-slate-100 dark:border-slate-900/60 pt-4 mt-2">
              <button
                type="button"
              ...
              <div className="flex gap-1">
                {[1, 2, 3, 4].map(s => (
                  <span 
                    key={s} 
                    className={`w-1.5 h-1.5 rounded-full transition-all ${activeStep === s ? "w-3.5 bg-indigo-500" : "bg-slate-300 dark:bg-slate-800"}`} 
                  />
                ))}
              </div>
