      ...
      <div className="border-b border-slate-800 bg-slate-950/95 backdrop-blur sticky top-0 z-20">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-sm font-bold text-slate-100 truncate">วิธีใช้งาน — จัด mapping field ภ.ง.ด. 90/94</h1>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-10">
        <section className="space-y-2">
          <p className="text-sm text-slate-300 leading-relaxed">
            ...
            หน้า <span className="text-slate-100 font-semibold">จัด mapping field</span> คือเครื่องมือที่ให้คลิกบอกระบบทีละช่อง
        ...
        <section>
          ...
          <p className="text-sm text-slate-300">
            เฉพาะบัญชีที่มี role เป็น <span className="font-semibold text-slate-100">Super Admin</span> เท่านั้นที่เปิดและบันทึก mapping ได้
            Admin/Staff ทั่วไปเข้าหน้านี้ไม่ได้ แต่ยัง<span className="text-slate-100">อ่าน</span>ผลลัพธ์ที่ map ไว้ได้ตามปกติ
        ...
        <section>
          ...
          <p className="text-sm text-slate-500 mb-4">
            ทำที่หน้า <code className="text-xs bg-slate-900 border border-slate-800 rounded px-1.5 py-0.5">/super-admin</code>{" "}
            ในโซนตั้งค่าที่มีกล่อง &quot;แบบฟอร์ม PDF: ภ.ง.ด. 90&quot; และ &quot;แบบฟอร์ม PDF: ภ.ง.ด. 94&quot;
          </p>
          <ol className="space-y-3 text-sm text-slate-300">
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-xs font-bold text-slate-400">1</span>
              <span>
                <span className="font-semibold text-slate-100">ภ.ง.ด. 90</span> ใช้ไฟล์เดียวร่วมกันทุกปีภาษี เลือกไฟล์แล้วอัปโหลดได้ทันที<br />
                <span className="font-semibold text-slate-100">ภ.ง.ด. 94</span> ต้องพิมพ์ปีภาษีก่อน (เช่น &quot;2026&quot;) แล้วกด &quot;อัปโหลด PDF สำหรับปี {"{"}ปี{"}"}&quot;
                เพราะปีภาษีถูกพิมพ์ตายตัวอยู่ในเนื้อฟอร์ม แก้ทีหลังไม่ได้
              </span>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-xs font-bold text-slate-400">2</span>
              <span>ระบบตรวจไฟล์ให้อัตโนมัติ: ต้องเป็น PDF จริง และขนาดไม่เกิน 5MB</span>
            </li>
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-xs font-bold text-slate-400">3</span>
              <span>
            ...
            <li className="flex gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-xs font-bold text-slate-400">4</span>
              <span>
        ...
        <section>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-xs text-slate-400">
            <span className="font-semibold text-slate-200">ถ้ามีหลายหน้าใน PDF —</span> ด้านบนจะมีแท็บ &quot;หน้า 1&quot;, &quot;หน้า 2&quot; ... ให้กดสลับ
        ...
        <section>
          ...
          <p className="text-sm text-slate-300 mb-4">
            ไม่มีการลากวางหรือพิมพ์พิกัด x/y — ทำได้อย่างเดียวคือ <span className="font-semibold text-slate-100">คลิกที่กรอบ</span> ที่ตรงกับช่องบนฟอร์มที่มองเห็น
            แล้วเลือกจาก dropdown ในกล่องที่เด้งขึ้นมา
          </p>

          <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 max-w-sm mx-auto">
            <h3 className="text-sm font-bold text-slate-100 mb-1">Text87.15</h3>
            ...
            <div className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-200 mb-3">
            ...
            <div className="flex gap-2 mt-4">
              <span className="flex-1 text-center px-3 py-2 rounded-lg text-xs font-semibold bg-slate-800 text-slate-300">ยกเลิก</span>
              <span className="flex-1 text-center px-3 py-2 rounded-lg text-xs font-semibold bg-red-950 border border-red-900 text-red-300">ลบ mapping</span>
          ...
          <ul className="text-sm text-slate-300 list-disc pl-5 mt-4 space-y-1">
            <li>ช่องข้อความ — ต้องเลือก <span className="font-semibold text-slate-100">ความหมาย</span> และ <span className="font-semibold text-slate-100">รูปแบบข้อมูล</span> (ระบบเดาให้อัตโนมัติแล้ว แก้ไขเองได้)</li>
            <li>ช่อง radio — ต้องเลือกทั้ง <span className="font-semibold text-slate-100">ความหมาย</span> และ <span className="font-semibold text-slate-100">ตัวเลือก</span></li>
          </ul>
          <p className="text-xs text-slate-500 mt-3">
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                {FIELD_GROUPS.map((row) => (
                  <tr key={row.section} className="border-b border-slate-800 last:border-0">
                    <td className="px-3 py-2 text-slate-200 font-medium whitespace-nowrap">{row.section}</td>
        ...
        <section>
          ...
          <ul className="text-sm text-slate-300 list-disc pl-5 space-y-1.5">
            <li><span className="font-semibold text-slate-100">ตัวเลข X / Y</span> — จำนวนความหมายที่จำเป็นซึ่ง map แล้ว เทียบกับทั้งหมดของฟอร์มนี้</li>
            ...
            <li>รายการ &quot;ยังไม่ได้ map อีก N รายการ&quot; — กดเพื่อดูรายชื่อ key ที่ยังขาด (เช่น <code className="bg-slate-900 border border-slate-800 rounded px-1">item.14</code>)</li>
        ...
        <section>
          ...
          <p className="text-sm text-slate-300 mb-3">
            หน้า mapping <span className="font-semibold text-slate-100">ไม่มีปุ่มพรีวิว/สร้าง PDF ตัวอย่าง</span> — วิธีทดสอบจริงคือไปที่หน้า{" "}
            <code className="text-xs bg-slate-900 border border-slate-800 rounded px-1.5 py-0.5">ภาษี (/tax)</code> ของฝั่ง Admin
          ...
          <div className="bg-amber-950/40 border border-amber-900 rounded-xl p-4 text-xs text-amber-200 flex gap-2.5">
        ...
        <section className="pb-4">
          ...
          <div className="space-y-4 text-sm">
            <div>
              <p className="font-semibold text-slate-100">ถ้าอัปโหลดไฟล์ผิด ต้องลบ mapping เดิมก่อนไหม</p>
            ...
            <div>
              <p className="font-semibold text-slate-100">ทำไม dropdown &quot;ความหมาย&quot; ไม่มีตัวเลือกที่ต้องการ</p>
            ...
            <div>
              <p className="font-semibold text-slate-100">ต้อง map ให้ครบ 100% ก่อนใช้งานจริงได้ไหม</p>
          ...
          <p className="text-xs text-slate-600 mt-6 pt-4 border-t border-slate-800">
