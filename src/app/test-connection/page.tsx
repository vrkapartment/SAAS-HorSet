    ...
    <DashboardLayout role={role}>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 relative z-10">
        <div>
          ...
          <p className="text-sm md:text-xs text-slate-400 mt-1 max-w-2xl leading-relaxed">
            {t("test_connection.subtitle")}
          </p>
        </div>
        <div className="text-xs md:text-[11px] font-extrabold px-4 py-3 md:py-2 bg-slate-900/80 border border-slate-800/80 rounded-xl flex items-center gap-2.5 backdrop-blur-md shadow-md text-slate-300 w-full md:w-auto justify-center md:justify-start">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          <div className="glass-card rounded-2xl p-5 md:p-6 border border-slate-900/60 relative overflow-hidden shadow-xl">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full sm:w-auto group relative flex items-center justify-center gap-2 bg-slate-900 border border-slate-800 hover:border-blue-500/50 text-slate-300 hover:text-white text-sm md:text-xs font-bold py-3.5 px-5 md:py-2 md:px-4 rounded-xl md:rounded-lg transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
              >
                <RefreshCw className={`w-4 h-4 md:w-3.5 md:h-3.5 text-blue-400 group-hover:rotate-180 transition-all duration-500 ${loading ? "animate-spin text-white" : ""}`} />
            ...
            {loading ? (
              <div className="py-10 flex flex-col items-center justify-center gap-4 text-center">
                ...
                <div className="space-y-2 max-w-sm">
                  <p className="text-sm md:text-xs font-bold text-slate-200 animate-pulse">{diagnosticStep}</p>
              ...
              <div className="space-y-6">
                ...
                <div className={`p-4 md:p-3.5 rounded-2xl flex items-start gap-3 border transition-all ${
                  result.success 
                    ? "bg-teal-500/5 border-teal-500/20 text-teal-300" 
                    : "bg-red-500/5 border-red-500/20 text-red-300"
                }`}>
                  {result.success ? (
                    <CheckCircle2 className="w-5.5 h-5.5 md:w-5 md:h-5 text-teal-400 shrink-0 mt-0.5" />
                  ) : (
                    <XCircle className="w-5.5 h-5.5 md:w-5 md:h-5 text-red-400 shrink-0 mt-0.5" />
                  )}
                  <div>
                    <h3 className="font-extrabold text-base md:text-sm flex items-center gap-1.5">
                      {result.success ? t("test_connection.connection_success") : t("test_connection.connection_failed")}
                      {result.success && <span className="text-xs md:text-[10px] bg-teal-500/10 px-2 py-0.5 md:py-0.2 rounded-full text-teal-400 font-bold border border-teal-500/10">Active</span>}
                    </h3>
                    <p className="text-sm md:text-[11px] text-slate-400 mt-1 leading-relaxed">
                      {result.message}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-5 md:p-4 bg-slate-950/40 border border-slate-900/60 rounded-2xl space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-3 px-2">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="w-14 h-14 md:w-12 md:h-12 bg-slate-900 border border-slate-800 rounded-2xl flex items-center justify-center text-slate-400 relative transition-all">
                        <Laptop className="w-6 h-6 md:w-5 md:h-5" />
                    ...
                    {/* Line 1 */}
                    <div className="flex items-center justify-center h-8 md:h-auto w-full md:flex-1">
                      <div className="w-0.5 h-8 md:w-full md:h-px bg-gradient-to-b md:bg-gradient-to-r from-teal-500 to-indigo-500 relative">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className={`w-14 h-14 md:w-12 md:h-12 bg-slate-900 border rounded-2xl flex items-center justify-center relative transition-all ${result.success ? "border-teal-500/20 text-teal-400" : "border-slate-800 text-slate-500"}`}>
                        <Cpu className="w-6 h-6 md:w-5 md:h-5" />
                    ...
                    {/* Line 2 */}
                    <div className="flex items-center justify-center h-8 md:h-auto w-full md:flex-1">
                      <div className={`w-0.5 h-8 md:w-full md:h-px relative ${result.success ? "bg-gradient-to-b md:bg-gradient-to-r from-teal-500 to-emerald-500" : "bg-slate-800"}`}>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className={`w-14 h-14 md:w-12 md:h-12 bg-slate-900 border rounded-2xl flex items-center justify-center relative transition-all ${result.success ? "border-emerald-500/20 text-emerald-400" : "border-slate-800 text-slate-500"}`}>
                ...
                {result.success && result.details && (
                  <div className="bg-slate-950/40 border border-slate-900 rounded-2xl p-5 space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-3 text-sm md:text-xs">
                      <div className="flex justify-between items-center p-4 md:p-3 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-800 hover:border-slate-700 transition-all">
                        <span className="text-slate-400 font-medium">{t("test_connection.auth_system")}</span>
                        <span className="text-teal-400 font-extrabold flex items-center gap-1.5 md:gap-1">
                          <CheckCircle2 className="w-4.5 h-4.5 md:w-4 md:h-4 text-teal-400" /> {result.details.authConnection === "ปกติ" ? t("test_connection.normal") : result.details.authConnection}
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-4 md:p-3 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-800 hover:border-slate-700 transition-all">
                        <span className="text-slate-400 font-medium">{t("test_connection.database_access")}</span>
                        <span className="text-teal-400 font-extrabold flex items-center gap-1.5 md:gap-1">
                          <CheckCircle2 className="w-4.5 h-4.5 md:w-4 md:h-4 text-teal-400" /> {result.details.databaseConnection.includes("ปกติ") ? t("test_connection.normal") : t("test_connection.limited")}
                        </span>
                      </div>
                    </div>
                    {!result.details.databaseConnection.includes("ปกติ") && (
                      <p className="text-xs md:text-[10px] text-amber-400 font-medium bg-amber-500/5 p-4 md:p-3 rounded-xl border border-amber-500/10 flex items-start gap-1.5 leading-relaxed mt-2">
                        <AlertCircle className="w-4 h-4 md:w-3.5 md:h-3.5 shrink-0 mt-0.5 text-amber-400" />
                ...
                {!result.success && result.error && (
                  <div className="bg-slate-950/40 border border-red-500/10 rounded-2xl p-5 space-y-2">
                    <h4 className="text-sm md:text-xs text-red-400 font-bold uppercase tracking-wider flex items-center gap-1">
                      <AlertCircle className="w-4.5 h-4.5 md:w-4 md:h-4 text-red-400" /> {t("test_connection.error_logs")}
                    </h4>
                    <pre className="text-xs md:text-[11px] text-slate-300 font-mono overflow-x-auto whitespace-pre-wrap bg-slate-950 p-4 rounded-xl border border-slate-900 leading-relaxed shadow-inner max-h-[180px]">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <button 
                        ...
                        className="text-sm md:text-[10px] py-2 md:py-0 px-1 md:px-0 text-blue-400 hover:text-blue-300 font-bold flex items-center gap-1.5"
                      >
                        {showKeys ? (
                          <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-3 text-sm md:text-xs">
                      
                      {/* ENV Item 1 */}
                      <div className="p-4 md:p-3.5 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-800 flex flex-col justify-between gap-2">
                        <div>
                          <div className="text-slate-500 font-mono text-[10px] md:text-[9px] mb-1">NEXT_PUBLIC_SUPABASE_URL</div>
                        ...
                        {showKeys && (
                          <div className="font-mono text-xs md:text-[9px] text-slate-400 bg-slate-950/80 p-2 md:p-1 rounded-xl md:rounded border border-slate-900 truncate">
                            https://***.supabase.co
                          </div>
                        )}
                      </div>
                      ...
                      <div className="p-4 md:p-3.5 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-800 flex flex-col justify-between gap-2">
                        <div>
                          <div className="text-slate-500 font-mono text-[10px] md:text-[9px] mb-1">NEXT_PUBLIC_SUPABASE_ANON_KEY</div>
                      ...
                      <div className="p-4 md:p-3.5 bg-slate-900/50 rounded-xl md:rounded-lg border border-slate-800 flex flex-col justify-between gap-2">
                        <div>
                          <div className="text-slate-500 font-mono text-[10px] md:text-[9px] mb-1">SUPABASE_SERVICE_ROLE_KEY</div>
              ...
              <div className="py-12 text-center text-slate-400 text-sm md:text-xs">
          ...
          <div className="glass-card rounded-2xl border border-slate-900/60 p-5 space-y-4">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm md:text-xs font-bold text-slate-200">Supabase SQL Schema Helper</span>
              </div>
              <button
                type="button"
                onClick={() => setShowSql(!showSql)}
                className="text-sm md:text-xs text-blue-400 hover:text-blue-300 font-bold flex items-center gap-1 py-2 px-3 md:py-0 md:px-0 bg-slate-900/60 md:bg-transparent border border-slate-850 md:border-none rounded-xl md:rounded-none transition-all"
              >
            ...
            {showSql && (
              <div className="space-y-2 animate-fade-in">
                <div className="relative">
                  <pre className="text-xs md:text-[10px] text-slate-300 font-mono bg-slate-950/90 p-4 rounded-xl border border-slate-900 overflow-x-auto whitespace-pre-wrap leading-relaxed shadow-inner max-h-[250px]">
                    {sqlSchemaSnippet}
                  </pre>
                  <button
                ...
                {copiedKey === "schema_sql" && (
                  <div className="text-xs md:text-[10px] text-emerald-400 font-bold flex items-center gap-1 bg-emerald-500/5 border border-emerald-500/10 p-2.5 rounded-lg justify-center animate-scale-up">
        ...
        <div className="md:col-span-5 space-y-6">
          <div className="glass-card rounded-2xl p-6 border border-slate-900/60 space-y-6 shadow-xl relative overflow-hidden">
            ...
            <div className="flex justify-between items-center bg-slate-950 p-1.5 rounded-xl border border-slate-900/80">
              {[1, 2, 3, 4].map((stepNum) => (
                <button
                  ...
                  className={`flex-1 py-2.5 md:py-1.5 rounded-lg text-xs md:text-[10px] font-black transition-all ${
                    activeStep === stepNum
            ...
            <div className="space-y-6 text-sm md:text-xs text-slate-300">
              
              {/* Step 1: Create Supabase Project */}
              {activeStep === 1 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 md:w-8 md:h-8 bg-blue-500/10 border border-blue-500/20 text-blue-400 rounded-xl flex items-center justify-center font-bold text-sm md:text-xs shrink-0">
                      1
                    </div>
                    <h4 className="font-extrabold text-base md:text-sm text-slate-200">{t("test_connection.step1_title")}</h4>
                  </div>
                  <p className="text-slate-400 text-sm md:text-xs leading-relaxed pl-1">
                    {t("test_connection.step1_desc")}
                  </p>
                  
                  <div className="p-4 md:p-3 bg-slate-950/60 rounded-xl border border-slate-900">
                    <a 
              ...
              {activeStep === 2 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-200">{t("test_connection.step2_title")}</h4>
                  </div>
                  <p className="text-slate-400 text-sm md:text-xs leading-relaxed pl-1">
                  ...
                  <div className="relative">
                    <div className="absolute top-2.5 right-2 flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="p-2 md:p-1 bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-400 hover:text-slate-200 rounded-xl md:rounded-lg transition-all"
                    ...
                    <div className="bg-slate-950 p-4 rounded-xl border border-slate-900 font-mono text-slate-300 space-y-2.5 overflow-x-auto text-xs md:text-[10px] leading-relaxed pt-10 md:pt-9">
              ...
              {activeStep === 3 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-200">{t("test_connection.step3_title")}</h4>
                  </div>
                  <p className="text-slate-400 text-sm md:text-xs leading-relaxed pl-1">
                    {t("test_connection.step3_desc")}
                  </p>
                  
                  <div className="p-4 md:p-3 bg-blue-500/5 rounded-xl border border-blue-500/10 text-xs md:text-[10px] text-slate-400 leading-relaxed pl-4 md:pl-3.5 relative">
              ...
              {activeStep === 4 && (
                <div className="space-y-4 animate-scale-up">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="font-extrabold text-base md:text-sm text-slate-200">{t("test_connection.step4_title")}</h4>
                  </div>
                  <p className="text-slate-400 text-sm md:text-xs leading-relaxed pl-1">
            ...
            <div className="flex justify-between items-center border-t border-slate-900/60 pt-4 mt-2">
              <button
                ...
                className="text-xs md:text-[10px] text-slate-400 hover:text-slate-200 font-extrabold disabled:opacity-30 disabled:pointer-events-none transition-all py-2 px-3 md:py-0 md:px-0 bg-slate-900/60 md:bg-transparent rounded-lg md:rounded-none"
              >
                ← ย้อนกลับ
              </button>
              ...
              <button
                ...
                className="text-xs md:text-[10px] text-blue-400 hover:text-blue-300 font-extrabold disabled:opacity-30 disabled:pointer-events-none transition-all py-2 px-3 md:py-0 md:px-0 bg-slate-900/60 md:bg-transparent rounded-lg md:rounded-none"
              >
                ขั้นตอนถัดไป →
              </button>
            </div>
