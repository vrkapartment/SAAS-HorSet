              ...
              <div className="space-y-6">
                ...
                <div className="p-5 md:p-4 bg-slate-950/40 border border-slate-900/60 rounded-2xl space-y-4">
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-3 px-2">
                    ...
                    {/* Line 1 */}
                    <div className="flex-1 flex md:flex-col items-center justify-center min-w-[30px] md:min-w-0 w-full md:w-auto">
                      <div className="h-0.5 md:h-px w-8 md:w-full bg-gradient-to-r from-teal-500 to-indigo-500 relative">
                    ...
                    {/* Line 2 */}
                    <div className="flex-1 flex md:flex-col items-center justify-center min-w-[30px] md:min-w-0 w-full md:w-auto">
                      <div className={`h-0.5 md:h-px w-8 md:w-full relative ${result.success ? "bg-gradient-to-r from-teal-500 to-emerald-500" : "bg-slate-800"}`}>
